...
public class EnemySlime : MonoBehaviour
{
    ...
    [SerializeField] private float _minGroundNormalY = .005f;
    [SerializeField] private float _pathLength = 2f;
    [SerializeField] private Point _tamplate;
    [SerializeField] private DieSlime _deadSlime;
    ...
    private void Start()
    {
        ...
        _firstPoint = Instantiate(_tamplate.gameObject, new Vector2(0, 0), Quaternion.identity);
        _secondPoint = Instantiate(_tamplate.gameObject, new Vector2(0, 0), Quaternion.identity);
